En este proyecto, tenemos la existencia de 3 ramas. Una de ellas, la rama main, es la cual no sigue un modelo FSM (TABLE-DRIVEN), si no que lo hace mediante condiciones. 
